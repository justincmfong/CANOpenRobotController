 ...
 * \file CiA402Drive.h
 * \author Justin Fong
 * \brief  The <code>CiA402Drive</code> class is used to interface with a CANOpen motor drive. According to the CiA402 standard
 *
...
#ifndef CIA402DRIVE_H_INCLUDED
#define CIA402DRIVE_H_INCLUDED
...
/**
 * @ingroup Robot
 * \brief Abstract class describing a CiA402Drive used to communicate with a CANbus device. Note that many functions are implemented according to the CiA 402 Standard (but can be overridden)
 *
 */
class CiA402Drive : public Drive{
   protected:
    /**
    ...
    /**
       *
       * \brief  Start the drive node and set the Velocity control in CANopen motor drive
       *
       *
       * NOTE: More details on params and profiles can be found in the CANopne CiA 402 series specifications:
       *           https://www.can-cia.org/can-knowledge/canopen/cia402/
   ...
   public:
    /**
        * \brief Construct a new CiA402Drive object
        *
        */
    CiA402Drive();
    ...
    /**
       ...
       */
    CiA402Drive(int node_id);

    /**
       * \brief Destroy the CiA402Drive object
       *
       */
    virtual ~CiA402Drive();
